		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="Board1" class="list-group-item active">게시판 목록</a> <a
						href="Board2" class="list-group-item">고객감동사례</a> <a href="Board3"
						class="list-group-item">자유게시판</a> <a href="Board4"
						class="list-group-item">FAQ</a> <a href="Board5"
