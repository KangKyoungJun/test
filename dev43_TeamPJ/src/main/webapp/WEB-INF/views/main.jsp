...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">Null PointException</a>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('resources/images/조깅8.jpg')">
				...
				<div class="carousel-item"
					style="background-image: url('resources/images/워치2.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h3>Second Slide</h3>
				...
				<div class="carousel-item"
					style="background-image: url('resources/images/병원.jpg')">
					<div class="carousel-caption d-none d-md-block">
						<h3>Third Slide</h3>
